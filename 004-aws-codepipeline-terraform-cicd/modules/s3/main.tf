...
resource "aws_s3_bucket_ownership_controls" "replication_bucket_acl_ownership_controls" {
  bucket = aws_s3_bucket.replication_bucket.id
...
resource "aws_s3_bucket_ownership_controls" "codepipeline_bucket_acl_ownership_controls" {
  bucket = aws_s3_bucket.codepipeline_bucket.id
